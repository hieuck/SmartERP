...
import { cancelOrder, closeOrder, createOrder, listOrders, reopenOrder, updateOrder } from "../../api";
...
export async function submitOrderReopen(input: ReopenOrderInput): Promise<OrderRecord> {
  return reopenOrder(input);
}
