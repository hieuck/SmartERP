...
function getAuditActionColor(actionType: AuditActionType): string {
  ...
  if (actionType === "invoice_return_authorized") {
    return "gold";
  }

  if (actionType === "invoice_return_amended") {
    return "processing";
  }
...
function getAuditActionLabel(
  ...
  if (actionType === "invoice_return_authorized") {
    return t("reports.auditActionInvoiceReturnAuthorized");
  }

  if (actionType === "invoice_return_amended") {
    return t("reports.auditActionInvoiceReturnAmended");
  }
  ...
  if (actionType === "invoice_return_settled") {
    return t("reports.auditActionInvoiceReturnSettled");
  }
