const en = {
  ...
  invoices: {
    ...
    returnAuthorizationCaseLabel: "Return case ID:",
    ...
    returnAuthorizationStatusClosed: "Closed",
    returnAuthorizationCloseNoteLabel: "Return case close note:",
    returnAuthorizationCloseAction: "Close Return Case",
    returnAuthorizationCloseTitle: "Close return case for {{number}}",
    returnAuthorizationCloseNote: "Return Case Close Note",
    returnAuthorizationCloseNoteHint:
      "Required to explain why the open return case for {{number}} is being closed without more warehouse or finance steps.",
    ...
    returnCaseQueueSummary:
      "{{open}} open, {{warehousePending}} waiting on warehouse, {{founderPending}} waiting on founder, {{financePending}} waiting on finance, {{closed}} closed, {{settled}} settled",
    ...
    returnCaseOwnerFounder: "Founder approval owns next step",
    returnCaseOwnerFinance: "Finance owns next step",
    returnCaseOwnerNone: "No open owner",
    returnCaseActionOwnerLabel: "Owner:",
    returnCaseActionRequiredLabel: "Next step:",
    returnCaseActionReceiveReturn: "Receive goods back into inventory",
    returnCaseActionApproveCredit: "Approve credit note before finance can settle",
    returnCaseActionPostCredit: "Post credit note",
    returnCaseActionClosed: "Case closed without more action",
    returnCaseActionSettled: "Case fully settled",
    returnCasePendingReceiptLabel: "Pending receipt:",
    returnCasePendingCreditLabel: "Pending credit:",
    returnAuthorizationAuthorizedAtLabel: "Authorized at:",
    returnAuthorizationClosedAtLabel: "Closed at:",
    returnAuthorizationPendingApprovalLabel: "Pending approval:",
    returnAuthorizationPendingApprovalAtLabel: "Approval requested:",
  ...
  reports: {
    ...
    auditReturnCaseLabel: "Return case:",
...
Object.assign(en.orders, {
  ...
  metricTotal: "Filtered orders",
  metricReadyInvoice: "Ready for invoice",
  metricReadyClose: "Ready to close",
  focusReadyTitle: "Push these confirmed orders into invoices",
  focusReadyCopy: "{{count}} confirmed order(s) are waiting for invoice issuance in the current scope.",
  focusCloseTitle: "These orders can be closed after settlement",
  focusCloseCopy: "{{count}} order(s) already have a paid invoice and can be closed when operations is ready.",
  focusStableTitle: "Order lane is stable for now",
  focusStableCopy: "No confirmed order is waiting on invoice issuance or close-out in the current scope.",
  pipelineTitle: "Order flow",
  pipelineMeta: "Use this to see how much demand is active in the current tenant and category.",
  billingTitle: "Billing handoff",
  billingMeta: "Confirmed orders should move to invoices before sales context drifts.",
  summaryValue: "Gross order value",
  summaryCustomers: "Customers in scope",
  summaryScope: "Current scope",
  summaryExceptions: "Canceled or returned",
  summaryActiveInvoice: "With active invoice",
  summaryClosed: "Closed orders",
...
Object.assign(en.inventory, {
  lowStock: "Low stock",
  metricLines: "Tracked SKUs",
  metricUnits: "Units on hand",
  metricValue: "Inventory value",
  metricOutOfStock: "Out of stock",
  focusRestockTitle: "These lines need replenishment attention",
  focusRestockCopy: "{{count}} SKU line(s) are out of stock or near depletion in the current scope.",
  focusHealthyTitle: "Stock lane looks healthy",
  focusHealthyCopy: "No SKU line is currently empty or near depletion in the current scope.",
  coverageTitle: "Stock coverage",
  coverageMeta: "Use this to see whether the current scope can keep serving orders without manual checks.",
  valueTitle: "Value and receipts",
  valueMeta: "Inventory value and recent receipts tell you where replenishment is anchored.",
  summaryLowStock: "Low stock",
  summaryNoReceipt: "No receipt history",
  summaryTrackedProducts: "Tracked products",
  summaryLatestReceipt: "Latest receipt",
  summaryLargestLine: "Largest value line",
  summaryScope: "Current scope",
});
