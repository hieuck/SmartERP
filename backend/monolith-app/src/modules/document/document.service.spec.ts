...
describe('DocumentService', () => {
  ...
  describe('findAll', () => {
    ...
    it('should find documents by parent', async () => {
      ...
      const result = await service.findAll('tenant-1', 'parent-1');
  ...
  describe('createFolder', () => {
    it('should create a folder', async () => {
      ...
      const result = await service.createFolder('tenant-1', 'New Folder', null, 'user-1');
  ...
  describe('createFile', () => {
    it('should create a file', async () => {
      ...
      const result = await service.createFile('tenant-1', fileData);
  ...
  describe('createVersion', () => {
    it('should create new version of document', async () => {
      ...
      const result = await service.createVersion('tenant-1', '1', '/new/path.pdf', 'user-1');
