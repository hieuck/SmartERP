...
describe('PaymentService', () => {
  ...
  describe('findByOrder', () => {
    it('should return payments for an order', async () => {
      ...
      const result = await service.findByOrder('order-1', 'tenant-1');
  ...
  describe('findByStatus', () => {
    it('should return payments by status', async () => {
      ...
      const result = await service.findByStatus('pending', 'tenant-1');
  ...
  describe('create', () => {
    it('should create a new payment', async () => {
      ...
      const result = await service.create(createData, 'tenant-1');
  ...
  describe('update', () => {
    it('should update a payment', async () => {
      ...
      const result = await service.update('1', updateData, 'tenant-1');
    ...
    it('should throw NotFoundException if payment not found', async () => {
      ...
      await expect(service.update('999', { amount: 1500 }, 'tenant-1')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('complete', () => {
    it('should complete a pending payment', async () => {
      ...
      const result = await service.complete('1', 'txn-123', 'tenant-1');
    ...
    it('should throw BadRequestException if payment is not pending or processing', async () => {
      ...
      await expect(service.complete('1', 'txn-123', 'tenant-1')).rejects.toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe('fail', () => {
    it('should fail a payment', async () => {
      ...
      const result = await service.fail('1', 'Insufficient funds', 'tenant-1');
    ...
    it('should throw BadRequestException if payment is completed', async () => {
      ...
      await expect(service.fail('1', 'Test reason', 'tenant-1')).rejects.toThrow(
        BadRequestException,
      );
    });
  });
  ...
  describe('refund', () => {
    it('should refund a completed payment', async () => {
      ...
      const result = await service.refund('1', 'tenant-1');
    ...
    it('should throw BadRequestException if payment is not completed', async () => {
      ...
      await expect(service.refund('1', 'tenant-1')).rejects.toThrow(BadRequestException);
    });
  });
  ...
  describe('getTotalAmount', () => {
    it('should return total amount for all payments', async () => {
      ...
      const result = await service.getTotalAmount('tenant-1');
    ...
    it('should return total amount for specific status', async () => {
      ...
      const result = await service.getTotalAmount('tenant-1', 'completed');
  ...
  describe('getPaymentsByDateRange', () => {
    it('should return payments within date range', async () => {
      ...
      const result = await service.getPaymentsByDateRange(startDate, endDate, 'tenant-1');
  ...
  describe('getPaymentStatistics', () => {
    it('should return payment statistics', async () => {
      ...
      const result = await service.getPaymentStatistics('tenant-1');
