...
describe('ImportExportService', () => {
  ...
  describe('exportToExcel', () => {
    it('should export data to Excel buffer', async () => {
      ...
      const result = await service.exportToExcel(mockTenantId, 'products', data);
    ...
    it('should handle empty data array', async () => {
      const result = await service.exportToExcel(mockTenantId, 'products', []);
  ...
  describe('exportToCSV', () => {
    it('should export data to CSV string', async () => {
      ...
      const result = await service.exportToCSV(mockTenantId, 'products', data);
    ...
    it('should return empty string for empty data', async () => {
      const result = await service.exportToCSV(mockTenantId, 'products', []);
    ...
    it('should handle data with different fields', async () => {
      ...
      const result = await service.exportToCSV(mockTenantId, 'inventory', data);
  ...
  describe('importFromExcel', () => {
    it('should import data from Excel buffer', async () => {
      ...
      const result = await service.importFromExcel(mockTenantId, 'products', buffer);
  ...
  describe('importFromCSV', () => {
    it('should import data from CSV string', async () => {
      ...
      const result = await service.importFromCSV(mockTenantId, 'products', csvContent);
    ...
    it('should parse CSV with multiple rows correctly', async () => {
      ...
      const result = await service.importFromCSV(mockTenantId, 'inventory', csvContent);
