...
import { Layout, Form, Input, Button, Card, Typography, Row, Col, Checkbox, Space, message, Alert, Progress } from 'antd';
...
import { sanitizeEmail, getPasswordStrength, getPasswordStrengthLabel, getPasswordStrengthColor } from '../../utils/sanitize';
