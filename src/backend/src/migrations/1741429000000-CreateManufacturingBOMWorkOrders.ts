  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE "work_centers" (
        ...
        CONSTRAINT "FK_work_centers_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE
      )
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE "boms" (
        ...
        "created_at" timestamp NOT NULL DEFAULT now(),
        "updated_at" timestamp NOT NULL DEFAULT now(),
        CONSTRAINT "FK_boms_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE,
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_boms_tenant_product" ON "boms" ("tenant_id", "product_id")`,
    );
    ...
    await queryRunner.query(`
      CREATE TABLE "bom_lines" (
        ...
        "created_at" timestamp NOT NULL DEFAULT now(),
        "updated_at" timestamp NOT NULL DEFAULT now(),
        CONSTRAINT "FK_bom_lines_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE,
        CONSTRAINT "FK_bom_lines_bom" FOREIGN KEY ("bom_id") REFERENCES "boms"("id") ON DELETE CASCADE,
        CONSTRAINT "FK_bom_lines_product" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE CASCADE
      )
    `);

    await queryRunner.query(`CREATE INDEX "IDX_bom_lines_tenant_id" ON "bom_lines" ("tenant_id")`);
    await queryRunner.query(
      `CREATE INDEX "IDX_bom_lines_tenant_bom" ON "bom_lines" ("tenant_id", "bom_id")`,
    );
    ...
    await queryRunner.query(`
      CREATE TABLE "routings" (
        ...
        "created_at" timestamp NOT NULL DEFAULT now(),
        "updated_at" timestamp NOT NULL DEFAULT now(),
        CONSTRAINT "FK_routings_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE,
        CONSTRAINT "FK_routings_bom" FOREIGN KEY ("bom_id") REFERENCES "boms"("id") ON DELETE CASCADE
      )
    `);

    await queryRunner.query(`CREATE INDEX "IDX_routings_tenant_id" ON "routings" ("tenant_id")`);
    await queryRunner.query(
      `CREATE INDEX "IDX_routings_tenant_bom" ON "routings" ("tenant_id", "bom_id")`,
    );
    ...
    await queryRunner.query(`
      CREATE TABLE "operations" (
        ...
        "created_at" timestamp NOT NULL DEFAULT now(),
        "updated_at" timestamp NOT NULL DEFAULT now(),
        CONSTRAINT "FK_operations_tenant" FOREIGN KEY ("tenant_id") REFERENCES "tenants"("id") ON DELETE CASCADE,
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_operations_tenant_routing" ON "operations" ("tenant_id", "routing_id")`,
    );
    ...
    await queryRunner.query(`
      CREATE TABLE "work_orders" (
        ...
        CONSTRAINT "FK_work_orders_bom" FOREIGN KEY ("bom_id") REFERENCES "boms"("id") ON DELETE SET NULL,
        CONSTRAINT "FK_work_orders_responsible" FOREIGN KEY ("responsible_id") REFERENCES "users"("id") ON DELETE SET NULL
      )
    `);
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_work_orders_tenant_product" ON "work_orders" ("tenant_id", "product_id")`,
    );
    await queryRunner.query(
