  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      CREATE TABLE tasks (
        ...
        CONSTRAINT fk_task_updated_by FOREIGN KEY (updated_by) REFERENCES users(id) ON DELETE SET NULL
      );
    `);
    ...
    await queryRunner.query(`
      CREATE TABLE task_dependencies (
        ...
        created_by UUID,
        CONSTRAINT fk_dependency_tenant FOREIGN KEY (tenant_id) REFERENCES tenants(id) ON DELETE CASCADE,
        ...
        CONSTRAINT fk_dependency_created_by FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL,
    ...
    await queryRunner.query(`
      CREATE TABLE time_entries (
        ...
        CONSTRAINT fk_time_entry_created_by FOREIGN KEY (created_by) REFERENCES users(id) ON DELETE SET NULL,
        CONSTRAINT fk_time_entry_updated_by FOREIGN KEY (updated_by) REFERENCES users(id) ON DELETE SET NULL
      );
    `);
