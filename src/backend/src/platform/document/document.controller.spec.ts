...
describe('DocumentController (Integration)', () => {
  ...
  describe('GET /documents', () => {
    it('should return all root documents when no parentId', async () => {
      ...
      expect((response as any).body).toEqual(documents);
  ...
  describe('GET /documents/search', () => {
    ...
    it('should require authentication', async () => {
      await request(app.getHttpServer()).get('/documents/search?q=test').expect(401);
    });
  });
  ...
  describe('GET /documents/:id', () => {
    it('should return document by ID', async () => {
      ...
      expect((response as any).body).toEqual(mockFile);
    ...
    it('should require authentication', async () => {
      await request(app.getHttpServer()).get('/documents/file-123').expect(401);
    });
  });
  ...
  describe('GET /documents/:id/versions', () => {
    it('should return document versions', async () => {
      ...
      expect((response as any).body).toEqual(versions);
      expect(documentService.findById).toHaveBeenCalledWith(mockUser, 'file-123');
    ...
    it('should require authentication', async () => {
      await request(app.getHttpServer()).get('/documents/file-123/versions').expect(401);
    });
  });
  ...
  describe('POST /documents/folders', () => {
    it('should create folder successfully', async () => {
      ...
      expect((response as any).body.name).toBe('Documents');
    ...
    it('should create subfolder with parentId', async () => {
      ...
      expect((response as any).body.parentId).toBe('folder-123');
  ...
  describe('POST /documents/files', () => {
    it('should create file successfully', async () => {
      ...
      expect((response as any).body.type).toBe(DocumentType.FILE);
    ...
    it('should create file in root when no parentId', async () => {
      ...
      expect((response as any).body.parentId).toBeNull();
    });
  ...
  describe('POST /documents/:id/versions', () => {
    it('should create new version successfully', async () => {
      ...
      expect((response as any).body.version).toBe(2);
  ...
  describe('PUT /documents/:id', () => {
    it('should update document successfully', async () => {
      ...
      expect((response as any).body.name).toBe('Updated Contract.pdf');
  ...
  describe('DELETE /documents/:id', () => {
    ...
    it('should require authentication', async () => {
      await request(app.getHttpServer()).delete('/documents/file-123').expect(401);
    });
  ...
  describe('Edge Cases', () => {
    it('should handle concurrent requests', async () => {
      ...
      const requests = Array(5)
        .fill(null)
        .map(() =>
          request(app.getHttpServer()).get('/documents').set('Authorization', 'Bearer valid-token'),
        );
    ...
    it('should handle multiple versions correctly', async () => {
      ...
      expect((response as any).body).toHaveLength(10);
    });
  });
});
